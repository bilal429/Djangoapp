...
from .views import product_create, product_list, product_update, product_delete,category_list, category_create, category_update, category_delete, home_view,category_view,products_by_category_view, product_detail_view
